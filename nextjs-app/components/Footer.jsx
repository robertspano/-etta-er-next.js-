        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="/help-center" className="text-gray-300 hover:text-white hover:underline transition-colors">
                  {language === 'is' ? 'Hjálparmiðstöð' : 'Help center'}
                </a></li>
                <li><a href="/getting-started" className="text-gray-300 hover:text-white hover:underline transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="/register-company" className="text-gray-300 hover:text-white hover:underline transition-colors">
                  {language === 'is' ? 'Skrá fyrirtæki' : 'Register business'}
                </a></li>
                <li><a href="/company-getting-started" className="text-gray-300 hover:text-white hover:underline transition-colors">
                  {language === 'is' ? 'Byrjendahandbók' : 'Getting started'}
                </a></li>
                <li><a href="/company-benefits" className="text-gray-300 hover:text-white hover:underline transition-colors">
