    ...
    <section className="bg-[#203563] relative overflow-hidden py-16 md:py-20 min-h-[600px]" style={{backgroundColor: '#203563', minHeight: '600px'}}>
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="flex flex-col md:flex-row min-h-[500px] md:min-h-[600px] items-center gap-4 md:gap-8">
          ...
          <div className="relative flex-1 flex justify-center lg:justify-end lg:pr-8 items-start lg:items-start pt-6">
            {/* Professional photo */}
            <Image 
              ...
              width={450}
              height={580}
              className="w-96 h-[480px] lg:w-[420px] lg:h-[540px] xl:w-[450px] xl:h-[580px] object-contain object-center"
            />
