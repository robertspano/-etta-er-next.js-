...
const AllCategoriesOverview = ({ translations }) => {
  ...
  const handleSubcategoryClick = (categoryKey, subcategoryKey = null) => {
    ...
    } else if (categoryKey === 'housingAssociations' || categoryKey === 'housing') {
      router.push('/post/housing-associations');
    } else if (categoryKey === 'moving') {
      router.push('/post/moving');
    } else if (categoryKey === 'xl') {
      router.push('/xl');
    } else if (categoryKey === 'craftsmen') {
      router.push('/categories/handcraft');
    } else if (categoryKey === 'housegarden') {
      router.push('/categories/house-garden');
    } else if (categoryKey === 'interior') {
      router.push('/categories/interior-renovation');
    } else if (categoryKey === 'construction') {
      router.push('/categories/build-new');
