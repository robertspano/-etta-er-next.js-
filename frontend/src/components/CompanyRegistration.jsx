        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">
              {translations.companyRegistrationTitle}
            </h1>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="electronicId" className="block text-sm font-medium text-gray-700 mb-1">
                {translations.electronicIdLabel} *
              </label>
              <Input
                id="electronicId"
                name="electronicId"
                type="tel"
                placeholder={translations.electronicIdPlaceholder}
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="agreement" className="text-gray-600">
                  {translations.companyRegistrationAgreement}
                </label>
              </div>
            </div>
