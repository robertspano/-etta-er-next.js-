...
const ProRegistrationLanding = ({ translations, language, setLanguage }) => {
  ...
  return (
    <div className="min-h-screen bg-[#0e2a47] text-white">
      {/* Simple Header */}
      <header className="bg-[#0e2a47] border-b border-blue-800/30">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            {/* Logo */}
            <Link to="/" className="text-2xl font-black text-white hover:text-blue-200 transition-colors">
              BuildConnect
            </Link>
            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-2 px-3 py-2 rounded-lg bg-blue-800/30 hover:bg-blue-700/40 text-white transition-colors"
                >
