...
const Hero = ({ translations }) => {
  ...
  const serviceCategories = [
    ...
    { 
      ...
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
          <path d="M16 12.5C16 11.67 15.33 11 14.5 11S13 11.67 13 12.5 13.67 14 14.5 14 16 13.33 16 12.5M14.5 9C12.57 9 11 10.57 11 12.5S12.57 16 14.5 16 18 14.43 18 12.5 16.43 9 14.5 9M22 12.5C22 6.81 17.69 2.5 12 2.5S2 6.81 2 12.5H4C4 7.81 7.81 4 12.5 4S21 7.81 21 12.5H22M17 15L15 17L17 19H15L13 17L15 15H17M19 17L17 19L19 21H17L15 19L17 17H19M21 19L19 21L21 23H19L17 21L19 19H21Z"/>
        </svg>
      ), 
