...
const Hero = ({ translations }) => {
  ...
  const serviceCategories = [
    ...
    { 
      ...
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
          <path d="M16 12.5c0-0.83-0.67-1.5-1.5-1.5S13 11.67 13 12.5s0.67 1.5 1.5 1.5S16 13.33 16 12.5z"/>
          <path d="M19.36 2.72L20.78 4.14L15.06 9.85C16.13 11.39 16.28 13.24 15.38 14.44L9.06 8.12C10.26 7.22 12.11 7.37 13.65 8.44L19.36 2.72M18 16V18H20V20H18C17.45 20 17 19.55 17 19V16H18M15.5 16C15.78 16 16 16.22 16 16.5S15.78 17 15.5 17S15 16.78 15 16.5S15.22 16 15.5 16M17.5 18C17.78 18 18 18.22 18 18.5S17.78 19 17.5 19S17 18.78 17 18.5S17.22 18 17.5 18M19.5 20C19.78 20 20 20.22 20 20.5S19.78 21 19.5 21S19 20.78 19 20.5S19.22 20 19.5 20"/>
        </svg>
      ), 
